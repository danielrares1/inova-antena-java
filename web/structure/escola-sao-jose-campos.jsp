<%-- 
    Document   : escola-saojose
    Created on : Oct 2, 2017, 5:48:53 PM
    Author     : Daniel
--%>
...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadore- São José dos Campos </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - SÃO JOSÉ DOS CAMPOS</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/escola-saojose.jpg" alt="Escola São José do Campo"/>
                </div>
            </div>
        </div>
        <section id="escolas">
