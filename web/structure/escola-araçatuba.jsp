    <%-- 
    Document   : escola-araçatuba
    Created on : 04/01/2019, 16:20:57
    Author     : Daniel
--%>
...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadores - Araçatuba </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - ARAÇATUBA</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="img-escola" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/etec-aracatuba.jpg" alt="Escola Araçatuba" />
                </div>
            </div>
        </div>
        <section id="escolas">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <p>
                             FAÇA SUA
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSd7hiMsFkCpDdAxfvZ-rDYvCPGEg93lBVXo9bNqV2k8x0vsYw/viewform" target="_blank"><strong>INSCRIÇÃO</strong></a> AQUI!</p><br>
                        </p><br>
