...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadores - Limeira</title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - LIMEIRA</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="img-escola" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/etec-limeira.jpg" alt="Escola Limeira"/>
                </div>
            </div>
        </div>
        <section id="escolas">
