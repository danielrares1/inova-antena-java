<%-- 
    Document   : escola-jaboticabal
    Created on : 04/09/2018, 20:15:14
    Author     : RENAN
--%>
...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadores - Jaboticabal </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - JABOTICABAL</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="img-escola" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/fatec-jaboticabal.jpg" alt="Escola Jaboticabal"/>
                </div>
            </div>
        </div>
        <section id="escolas">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <p>
                           FAÇA SUA
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSczjFv9UqyYvfd-gEdneft69ZXNxiFQLD2bHIeEdcFmrJSW5Q/viewform" target="_blank"><strong>INSCRIÇÃO</strong></a> AQUI!</p><br>
                        </p><br>
                    </div>
                </div>
            </div>
