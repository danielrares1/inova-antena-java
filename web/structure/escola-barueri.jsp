<%-- 
    Document   : escola-barueri
    Created on : 04/09/2018, 20:50:05
    Author     : Daniel
...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadore- Barueri </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - BARUERI</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="img-escola" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/fatec-barueri.jpg" alt="Escola Barueri"/>
                </div>
            </div>
        </div>
        <section id="escolas">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                    <p>Aguarde abertura do edital <strong>a partir de 01/08 </strong>para verificar a disponibilidade da Escola de Inovadores nesta unidade.</p><br>
