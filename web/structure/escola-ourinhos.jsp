...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadores - Ourinhos </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - OURINHOS</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="img-escola" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/fatec-ourinhos.jpg" alt="Escola Ourinhos"/>
                </div>
            </div>
        </div>
        <section id="escolas">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <p>
                             FAÇA SUA
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLScvinM8LjcBzJXpKYGjqxubDCF0y4FmZruxazAHTD_s-38Big/viewform" target="_blank"><strong>INSCRIÇÃO</strong></a> AQUI!
                        </p><br>
                    </div>
                </div>
            </div>
