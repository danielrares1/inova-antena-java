<%-- 
    Document   : escola-adamantina
    Created on : 04/09/2018, 19:48:53
    Author     : RENAN
--%>
...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadores - Santana do Parnaíba </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - SANTANA DO PARNAÍBA</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="img-escola" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/etec-santana-parnaiba.jpg" alt="Escola Santana do Parnaíba"/>
                </div>
            </div>
        </div>
        <section id="escolas">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <p>FAÇA SUA <a href="https://docs.google.com/forms/d/e/1FAIpQLSeoqFUFs_T9CT6mPaC7PD8DUxenvRFw1Rq9LsVUIGmP8vHo-A/viewform" target="_blank"><strong>INSCRIÇÃO</strong></a> AQUI!</p><br>
                        </p><br>
                    </div>
                </div>
            </div>
