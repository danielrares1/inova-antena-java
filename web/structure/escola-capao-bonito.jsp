...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadores - Capao Bonito </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - CAPÃO BONITO</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="img-escola" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/etec-fatec-capao-bonito.jpg" alt="Escola Capao Bonito"/>
                </div>
            </div>
        </div>
        <section id="escolas">
            <div class="container">
                <div class="row">
                    ...
                    <p>    
                        FAÇA SUA
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSfyDhwPTHE3WFco8_SdVFzrQ1iPVGT5PFi4g_gjNZCepApfbw/viewform" target="_blank"><strong>INSCRIÇÃO</strong></a> AQUI!</p><br>
                    </p><br>
                    </div>
                </div>
            </div>
