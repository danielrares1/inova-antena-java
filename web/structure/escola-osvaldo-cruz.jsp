<%-- 
    Document   : escola-ourinhos
    Created on : 07/01/2019, 13:16:43
    Author     : Daniel
--%>
...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadores - Osvaldo Cruz </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - OSVALDO CRUZ</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="img-escola" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/etec-osvaldo-cruz.jpg" alt="Escola Osvaldo Cruz"/>
                </div>
            </div>
        </div>
        <section id="escolas">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <p>
                            FAÇA SUA 
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSewYrM0gJSjz_7o3xlkUtNzBsVdK1elBqgQRJJc3wVGaGumSA/viewform" target="_blank"><strong>INSCRIÇÃO</strong></a> AQUI!
                        </p><br>
                    </div>
                </div>
            </div>
