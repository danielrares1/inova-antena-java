<%-- 
    Document   : escola-mogi-cruzes
    Created on : 07/01/2019, 12:36:19
    Author     : RENAN
--%>
...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadores - Mogi das Cruzes </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - MOGI DAS CRUZES</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="img-escola" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/fatec-mogi-cruzes.jpg" alt="Escola Mogi das Cruzes"/>
                </div>
            </div>
        </div>
        <section id="escolas">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <p>
                            FAÇA SUA
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSea3M7cTHETlqOqDXv0wv3laN-QSa8YTTWjBRk1InjlIIDGZw/viewform" target="_blank"><strong>INSCRIÇÃO</strong></a> AQUI!</p><br>
                        </p><br>
                    </div>
                </div>
            </div>
