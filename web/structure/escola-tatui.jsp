...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadores - Tatuí </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - TATUÍ </h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="img-escola" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/fatec-tatui.jpg" alt="Escola Tatui"/>
                </div>
            </div>
        </div>
        <section id="escolas">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                       <p>
                          FAÇA SUA
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSdFeLN6kzmr84wHTHPBNdweCHMBKlYxoKDjaj6jP6se0OfZbw/viewform" target="_blank"><strong>INSCRIÇÃO</strong></a> AQUI!
                    </div>
                </div>
            </div>
        </section>
