<%-- 
    Document   : escola-ribeirao-preto
    Created on : 07/01/2019, 14:00:17
    Author     : RENAN
--%>
...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadores - Ribeirão Preto </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - RIBEIRÃO PRETO</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="img-escola" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/fatec-ribeirao-preto.jpg" alt="Escola Ribeirao Preto"/>
                </div>
            </div>
        </div>
        <section id="escolas">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <p>
                           FAÇA SUA
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSc4zol1R5nKxWzoUdS0lnwUOTWgi9lqipwSqXsULNps51nhgA/viewform" target="_blank"><strong>INSCRIÇÃO</strong></a> AQUI!
                        </p><br>
