<%-- 
    Document   : escola-guaratingueta
    Created on : 04/09/2018, 21:04:46
    Author     : Daniel
--%>
...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadore- Guartingueta </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - Guaratingueta</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="img-escola" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/fatec-guaratingueta.jpg" alt="Escola Ibitinga"/>
                </div>
            </div>
        </div>
        <section id="escolas">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <p>
                            FAÇA SUA
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSeA4m9Ic6MzGoXwgqzDWO62K509hIjFtchrJFLdDAbcEEIZrQ/viewform" target="_blank"><strong>INSCRIÇÃO</strong></a> AQUI!</p><br>
                        </p><br>
                    </div>
                </div>
            </div>
