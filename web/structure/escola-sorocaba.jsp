...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadores - Sorocaba </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - SOROCABA</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="img-escola" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/fatec-sorocaba.jpg" alt="Escola Sorocaba"/>
                </div>
            </div>
        </div>
        <section id="escolas">
            <div class="container">
                <div class="row">
                 ...
                 <p>
                    FAÇA SUA
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLScYZwvPTgncL2uFZdAvaDgDZ4b4UJEcZOfEcjuT8Y9aeapmIQ/viewform"target="_blank"><strong>INSCRIÇÃO</strong></a> AQUI!
                 </p><br>
                    </div>
                </div>
            </div>
