...
<html lang="pt">
    <head>
        ...
        <title>Escola de Inovadores - Campinas </title>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <div class="text-border">
                                <h1 class="text-dec">ESCOLA DE INOVADORES - CAMPINAS</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <br><br><br><br>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <img class="banner-escolas-sombra" src="<%=request.getContextPath()%>/res/images/escola/unidades/etec-bento-quirino.jpg" alt="Escola Campinas"/>
                </div>
            </div>
        </div>
        <section id="escolas">
            <div class="container">
                <div class="row">
                   ...
                   <p>
                               FAÇA SUA
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSfbtNs0XqS48Jjj-T2gGuKrQaMy4C7C18jzA1Pb0jilU5smRg/viewform" target="_blank"><strong>INSCRIÇÃO</strong></a> AQUI!</p><br>
                    </div>
                </div>
            </div>
        </section>
