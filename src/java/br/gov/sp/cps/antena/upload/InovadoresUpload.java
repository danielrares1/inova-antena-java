package br.gov.sp.cps.antena.upload;
...
@WebServlet("/inovadoresUpload")
public class InovadoresUpload extends HttpServlet {

    private static final long serialVersionUID = 1L;
    
    public InovadoresUpload() {
        super();
    }

    //Keep in mind that this file path is for Linux OS
    private String filePath = "C:/Guru/";
